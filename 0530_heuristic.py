...
# 5. 輸出比較結果
print("-" * 30)
print(f"求解完成！耗時: {solve_time:.6f} 秒")
...
algo_result = {
    algo_name: {
        ...
        "history": history_log  # ★ 成功把生長紀錄交接給 JSON！
    }
}

# 3. 讀取共用成績單 results.json
